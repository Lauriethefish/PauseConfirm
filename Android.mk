...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"pause-confirm"' -DVERSION='"0.2.1"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
